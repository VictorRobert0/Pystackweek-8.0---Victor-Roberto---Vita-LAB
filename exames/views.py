...
def cancelar_pedido(request, pedido_id):
    ...
    if not pedido.usuario == request.user:
        messages.add_message(request, constants.ERROR, 'Esse pedido não é seu, portando, você não pode cancelar!')
        return redirect ('/exames/gerenciar_pedidos/')
    pedido.agendado = False
    pedido.save()

    messages.add_message(request, constants.SUCCESS, 'Pedido de cancelamento realizado com sucesso')
    return redirect ('/exames/gerenciar_pedidos/')
...
def permitir_abrir_exame(request, exame_id):
    ...
    if not exame.requer_senha:
        ...
        return redirect('/exames/solicitar_senha_exame.html/')
